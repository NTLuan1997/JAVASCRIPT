...
let Obj = [
    {
        ...
        images: ["https://abc.com/image2.jpg"]
    },
    {
        id: 666666,     
        inventories: [
        ...
        images: ["https://abc.com/image3.jpg"]
    }
];

let result = Obj.reduce(function(accument, current) {
        let inventories = current.inventories;
        delete current.inventories;
        for(let item of inventories) {
            let convert = {};
            Object.assign(convert, current, item);
            accument.push(convert);
        }
        return accument;
}, []);
